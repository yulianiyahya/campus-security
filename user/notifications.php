                    ...
                    <div class="card-body p-0">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <?php if ($notif['reference_id'] && $notif['type'] == 'report_update'): ?>
                                                        <a href="report_detail.php?id=<?= $notif['reference_id'] ?>" class="btn btn-sm btn-outline-primary mb-2">
                        ...
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Anda akan menerima notifikasi di sini ketika ada pembaruan laporan</p>
                            </div>
                        <?php endif; ?>
                    </div>
                    <?php if (count($notifications) > 0): ?>
